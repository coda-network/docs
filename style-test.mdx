...
Use this page to verify that the documentation feels consistent with the Coda Network website across typography, color, surfaces, borders, and interactive components.
...
Coda Network provides the **decision layer for digital asset transactions**. It brings wallet context, institutional intelligence, and policy together before an action is approved.
...
A <Tooltip
  headline="Decision evidence"
  tip="The structured record of evaluated context, policy, and outcome."
>
  decision evidence record
</Tooltip> should make every authorization outcome explainable.
